   ...
   <div class="container-fluid" style="padding: 0px;">
      <div class="row"> 
        ...
        <!-- place your image here -->
               <img src="images/jpeg.jpg"  style="width: 100%;">
...
<div class="row">
   ...
   <div class="row">
       <div class="col-md-8">
           <img src="images/kandy-1.jpg" class="img-fluid">
       </div>
       
               <aside class="col-md-4">
<div class="mapouter"><div class="gmap_canvas"><iframe width="380" height="365" id="gmap_canvas" src="https://maps.google.com/maps?q=Kandy&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>Google Maps Generator by <a href="https://www.embedgooglemap.net">embedgooglemap.net</a></div><style>.mapouter{position:relative;text-align:right;height:365px;width:380px;}.gmap_canvas {overflow:hidden;background:none!important;height:365px;width:380px;}</style></div>
        </aside>
    ...
    <div class="row">
        <section class="col-md-8">
            <br>
            <h3 style="color: #3366ff">Kandy</h3>
            <p>
...
<aside class="col-md-4">
    <br>
<a class="weatherwidget-io" href="https://forecast7.com/en/7d2980d63/kandy/" data-label_1="KANDY" data-label_2="WEATHER" style="width:380px" data-theme="original" >KANDY WEATHER</a>
       <br>
    <div class="embed-responsive embed-responsive-4by3"  style="width:380px">
<iframe width="560" height="315" src="https://www.youtube.com/embed/V-bJGT5iHV8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
