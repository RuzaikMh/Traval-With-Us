...
<html>
  ...
  <ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item active" aria-current="page">Polonnaruwa</li>
  </ol>
</nav>
   </div>
...
<div class="mapouter"><div class="gmap_canvas"><iframe width="380" height="365" id="gmap_canvas" src="https://maps.google.com/maps?q=Polonnaruwa&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>Google Maps Generator by <a href="https://www.embedgooglemap.net">embedgooglemap.net</a></div><style>.mapouter{position:relative;text-align:right;height:365px;width:380px;}.gmap_canvas {overflow:hidden;background:none!important;height:365px;width:380px;}</style></div>
    ...
    <div class="row">
        <section class="col-md-8">
            <br>
            <h3 style="color: #3366ff">Polonnaruwa</h3>
            <p>
...
<aside class="col-md-4">
    <br>
<a class="weatherwidget-io" href="https://forecast7.com/en/7d9481d02/polonnaruwa/" data-label_1="POLONNARUWA" data-label_2="WEATHER" style="width:380px" data-theme="original" >POLONNARUWA WEATHER</a>
       <br>
    <div class="embed-responsive embed-responsive-4by3"  style="width:380px">
<iframe width="560" height="315" src="https://www.youtube.com/embed/RjNkLpHtkhI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
       ...
       <div class="row d-flex">
           ...
           <h4>Places To Stay in Polonnaruwa</h4>
